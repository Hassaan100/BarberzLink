...
const Footer = () => {
  return (
    <footer className="bg-black text-white/80 px-4 sm:px-8 lg:px-12 pt-12 lg:pt-16 pb-8 w-full border-t border-[#ffffff4f]">
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 mb-10 lg:mb-14">
        <div className="col-span-2 sm:col-span-2 lg:col-span-1">
          <img src={logo} alt="Barberz Link" width={80} className="mb-4" />
